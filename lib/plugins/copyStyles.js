...
if(StyleSheet&&(0,_isNumber2.default)(stylesheetOrObject)){
...
if(!(0,_isWeb2.default)()||(0,_isWeb.isWebVoidElement)(element)){
...
newStyle=_extends({},newStyle,maybeFlatten(style));
...
var animatedValues=Object.keys(css).reduce(function(prev,curr){
if(typeof css[curr]!=='object'||!css[curr].__getValue)return prev;
return _extends({},prev,_defineProperty({},curr,css[curr]));
},{});
...
style:_extends({},props.style,animatedValues),
